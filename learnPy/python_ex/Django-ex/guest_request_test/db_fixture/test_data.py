...
datas={
	...
	'sign_event':[
		...
		{'id':4,'name':'发布会结束','limit':2000,'status':1,'address':'北京会展中心','start_time':'2017-08-20 14:00:00'},
		{'id':5,'name':'小米5发布会','limit':2000,'status':1,'address':'北京国家会议中心','start_time':'2017-08-20 14:00:00'},
	],
	#嘉宾表数据
	'sign_guest':[
		{'id':1,'realname':'alen','phone':13511001100,'email':'alen@email.com','sign':0,'event_id':1},
		{'id':2,'realname':'has sign','phone':13511001101,'email':'sign@email.com','sign':1,'event_id':1},
		{'id':3,'realname':'tom','phone':13511001102,'email':'tom@email.com','sign':0,'event_id':5},
	],
}
