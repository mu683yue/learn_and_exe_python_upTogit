...
class AddEventTest(unittest.TestCase):
	...
	def test_add_event_all_null(self):
		...
		payload = {'eid':'','linit':'','address':'','start_time':''}
		r=response.post(self.base_url,data=payload)
		self.result = r.json()
	...
	def test_add_event_name_exists(self):
		...
		r.response.post(self.base_url,payload)
		self.result=r.json()
	...
	def test_add_event_data_success(self):
		'''添加成功'''
